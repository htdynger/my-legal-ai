...
const MobileInputFooter = ({ translateY, isSwiping, handleTouchStart, handleTouchMove, handleTouchEnd, messageText, setMessageText, mobileNewChatURL, mobileAddFileURL, mobileExplainURL, handleSendMessage, mobileSendMessageURL }) => {
